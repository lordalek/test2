...
class BinaryNodeComparable {
	private Point2D bottomPoint, topPoint, valuePosition;
	private Ellipse2D shape;
	private int sizeOfNode = 50;
	// Constructors
	BinaryNodeComparable(Comparable theElement, int posX, int posY) {
		element = theElement;
		left = right = null;
	...
	BinaryNodeComparable left; // Left child
	BinaryNodeComparable right; // Right child
}