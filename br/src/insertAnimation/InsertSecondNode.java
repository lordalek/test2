...
public class InsertSecondNode extends JApplet {
	...
	private class DrawingPanel extends AbstractDrawingPanel{
		...
		private GraphicalNode node15, node10, nullNodeLeft, nullNodeRight, tierTwoNullNodeRight, tierTwoNullNodeLeft, returnNode, node13, tierThreeNullNodeRight, tierThreeNullNodeLeft;
		public DrawingPanel(){
		...
		public void paintComponent(Graphics g){
			...
			if(iteration == 4){
				...
				returnNode = new GraphicalNode("10", 70+j, (int) (100-y));
			...
			if(iteration == 6){
				...
				node13  = new GraphicalNode("13", 270-j, 30);
				paintNode(node13, g2);
			...
			if(iteration == 7){
				...
				node13 = new  GraphicalNode("13", 140-i, 30+y);
				paintNode(node13, g2);
				paintNode(node15, g2);
				paintNode(tierTwoNullNodeRight, g2);				
				paintLine(node10, tierTwoNullNodeRight, g2);
			...
			if(iteration == 8){
				...
				node13 = new  GraphicalNode("13", 70+j, 100+y2);
				paintNode(node13, g2);
				paintNode(node15, g2);
				paintNode(tierTwoNullNodeLeft, g2);
				paintLine(node10, tierTwoNullNodeLeft, g2);
			...
			if(iteration == 9){
				...
				g2.drawString("and generates its" , 10, 40);
				g2.drawString("own subtree." , 10, 60);
				node13 = new  GraphicalNode("13", 140, 170);
				paintNode(node13, g2);
				paintNode(node15, g2);
				paintNode(tierTwoNullNodeLeft, g2);
				paintLine(node10, tierTwoNullNodeLeft, g2);
				...
				if(y <= 69) y+=2;
				if(y >= 69 && i >= 69) iteration++; j = 0; y2 = 0;
				tierThreeNullNodeRight = new GraphicalNode("null", 140+i, 170+y);
				tierThreeNullNodeLeft = new GraphicalNode("null", 140-i, 170+y);
			...
			if(iteration == 10){
				tierThreeNullNodeRight = new GraphicalNode("null", 210, 240);
				tierThreeNullNodeLeft = new GraphicalNode("null", 70, 240);
				paintNode(tierThreeNullNodeRight, g2);
				paintLine(node13, tierThreeNullNodeRight, g2);
				paintNode(tierThreeNullNodeLeft, g2);
				paintLine(node13, tierThreeNullNodeLeft, g2);
				...
				g2.setColor(Color.RED);
				returnNode = new GraphicalNode("13", 140-j, (int) (170-y2));
				paintNode(returnNode, g2);
				g2.setColor(Color.BLACK);
			}
			...
			if(iteration == 11){
				...
				returnNode = new GraphicalNode("10", 70+i, (int) (100-y3));
				paintNode(returnNode, g2);
